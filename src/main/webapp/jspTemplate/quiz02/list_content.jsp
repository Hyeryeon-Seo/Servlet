...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!--  여기 아래에다가 곡 데이터 복붙하면됨  / ctl space바로 자동완성 -->
<!--  곡제목보다는 번호로 넘기는게 좋다. 제목은 중복도 가능하므로 /  -->
...
<html>
	...
	<body>
		...
		<% //스크립틀릿 열기
			...
			Map<String, Object> target = null; // new hashmap이든 .. 나중에 채워주면됨
			
			// 1. id만 넘어오는 경우
			for (Map<String, Object> item : musicList) { // 같을 떄 target 저장
				if ((int)item.get("id") == id) {  // int로 변환해줘야 비교 가능 ==
					target = item;
					break;  // break해줘야 조금이라도 반복문 덜 돌아
				}
